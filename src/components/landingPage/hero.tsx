...
const Hero = () => {
    return (
        <div className="bg-amethyst p-10">
            ...
            <a href="#_" className="relative inline-flex p-5 ml-5 items-center px-12 py-3 overflow-hidden text-lg font-medium text-white border-2 border-white rounded-full hover:text-white group hover:bg-gray-50">

    ...
    return (
        <div className="pricing w-full h-landing-box space-x-10 bg-menu-white">
                <div className="card bg-wisteria w-72 h-96">
                    <h1 className="text-4xl py-3 text-menu-white">FREE</h1>
                ...
                <div className="card bg-wisteria w-80 h-100">
                    <h1 className="text-4xl py-3 text-menu-white" >79$/mo</h1>
                ...
                <div className="card bg-wisteria w-72 h-96">
                    <h1 className="text-4xl py-3 text-menu-white">499$/mo</h1>

...
const Sidebar = () => {
  return (
    <nav className="h-full w-20 fixed z-[1] bg-[#9B72CF] overflow-x-hidden pt-5 left-0 top-0">
      ...
      height={30} /></a></li>
      <li className="list-none mt-1.5"><a href="/home" className="no-underline text-25px text-[#2f184b] block pl-4 pr-2 py-1.5 hover:text-[#f1f1f1]"><Image src={edit} alt="edit icon" width={30}
      height={30}/></a></li>
